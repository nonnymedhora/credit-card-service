 ...
 * CBC mode for encryption and decryption  _AES_CBC 
 */
...
public class BouncyCastleProvider{
    ...
    public BouncyCastleProvider(String pass, byte[] iv){
        //get the key and the IV
        key = pass.getBytes();
        IV = new byte[blockSize];
        System.arraycopy(iv, 0 , IV, 0, iv.length);
    }
    public BouncyCastleProvider(byte[] pass, byte[]iv){
        //get the key and the IV
    ...
    public void InitCiphers()
       ...
       encryptCipher =
               Cipher.getInstance("AES/CBC/PKCS7Padding", "BC");//PKCS5Padding
    ...
    public static String decryptCardNumber(String encryptedNumber) {
    	return null;
    }
