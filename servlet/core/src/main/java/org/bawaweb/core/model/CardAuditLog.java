 ...
 *create table card_audit_log (
	...
	request_id			integer(9) not null,
	user_id				integer(9) not null,
	card_id				integer(9) not null,
	...
	index card_audit_ind3 (request_id),
	constraint fk_card_audit_id 
	foreign key (customer_id) references customer_card(customer_id),
...
@TableGenerator(
        ...
        initialValue=10000,
        allocationSize=1)
@NamedQueries( { @NamedQuery(name = "CardAuditLog.getMaxRequestID", query = "select max(c.requestId) as maxRequestId from CardAuditLog c") })
...
//	@TableGenerator(
//			name="requestIdLogGen",
//			table="ID_GEN",
//			pkColumnName="GEN_NAME",
//			valueColumnName="GEN_VALUE", 
//	        pkColumnValue="REQUEST_ID",
//	        initialValue=1,
//	        allocationSize=1)
//	@GeneratedValue(strategy=GenerationType.TABLE, generator="requestIdLogGen")
	...
	public String toString() {
		return "CardAuditLog [auditId=" + auditId + ", requestId=" + requestId
